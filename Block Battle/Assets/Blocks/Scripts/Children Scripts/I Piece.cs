...
public class IPiece : PieceScript
{
    PieceType _childPieceType = PieceType.I;

    // Piece inital positions for the I piece
    private Vector2Int[] _initalPositions = new Vector2Int[4] {
        new Vector2Int(1, 3), // Left most piece
        new Vector2Int(1, 4), // Left center
        new Vector2Int(1, 5), // Right center
        new Vector2Int(1, 6) // Right most piece
    }; // I p
