...
public static class KickTableManager
{
    ...
    {
        { (0, 1),  new Vector2Int[] { new(0, 0), new(0, -1), new(-1, -1), new(2, 0), new(2, -1) } },
        { (1, 0),  new Vector2Int[] { new(0, 0), new(0, 1), new(-1, 1), new(2, 0), new(2, 1) } },

        { (1, 2),  new Vector2Int[] { new(0, 0), new(0, 1), new(1, 1), new(-2, 0), new(-2, 1) } },
        { (2, 1),  new Vector2Int[] { new(0, 0), new(0, 1), new(1, 1), new(-2, 0), new(-2, 1) } },

        { (2, 3),  new Vector2Int[] { new(0, 0), new(0, 1), new(-1, 1), new(2, 0), new(2, 1) } },
        { (3, 2),  new Vector2Int[] { new(0, 0), new(0, -1), new(-1, -1), new(2, 0), new(2, -1) } },

        { (3, 0),  new Vector2Int[] { new(0, 0), new(0, -1), new(1, -1), new(-2, 0), new(-2, -1) } },
        { (0, 3),  new Vector2Int[] { new(0, 0), new(0, -1), new(1, -1), new(-2, 0), new(-2, -1) } }
    };
